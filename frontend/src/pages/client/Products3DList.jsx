      ...
      <div className="gallery-page">
        ...
        <div className="gallery-hero">
          ...
          <p className="gallery-subtitle">
            Khám phá bộ sưu tập sản phẩm dưới góc nhìn 360° tương tác.
            Click vào sản phẩm để trải nghiệm chi tiết.
          </p>
        </div>
            ...
            {MODELS_3D.map((model, i) => (
              ...
              >
                <div className="card-img-wrapper">
                  {model.image ? (
                    <img className="card-img" src={model.image} alt={model.title} />
                  ) : (
