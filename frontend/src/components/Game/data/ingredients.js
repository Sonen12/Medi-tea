...
const ingredients = [
  ...
  // ─── THẢO MỘC ────────────────────────────────────────
  {
    ...
    sideEffects: ["Quá nhiều gây ợ nóng", "Không nên dùng khi có trào ngược dạ dày"],
    caffeineLevel: 0,
  ...
  },
  {
    ...
    sideEffects: ["Uống quá nhiều có thể gây chóng mặt", "Phụ nữ mang thai nên hạn chế"],
    caffeineLevel: 0,
  ...
  // ─── GIA VỊ ───────────────────────────────────────────
  {
    ...
    sideEffects: ["Cay nóng — dễ gây nóng trong nếu dùng nhiều", "Người bị loét dạ dày nên tránh", "Có thể tương tác thuốc chống đông máu"],
    caffeineLevel: 0,
  ...
  },
  {
    ...
    sideEffects: ["Quế Cassia chứa coumarin — hại gan nếu dùng quá nhiều", "Tối đa 1 thanh nhỏ/ngày", "Không nên dùng cho phụ nữ mang thai"],
    caffeineLevel: 0,
  ...
  // ─── TRÁI CÂY ────────────────────────────────────────
  {
    ...
    sideEffects: ["Acid cao — hại men răng nếu uống thường xuyên", "Gây ợ chua ở người trào ngược"],
    caffeineLevel: 0,
  ...
  // ─── CHẤT TẠO NGỌT ───────────────────────────────────
  {
    ...
    sideEffects: ["Không cho vào nước sôi (>60°C) — mất enzyme", "Đường cao — không phù hợp cho người tiểu đường", "Trẻ dưới 1 tuổi không nên dùng"],
    caffeineLevel: 0,
